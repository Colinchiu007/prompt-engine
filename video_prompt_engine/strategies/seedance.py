...
Output ONLY a JSON object with exactly: prompt / shot / camera / motion_intensity / scene_transition / continuity_token / duration_hint / positive_constraints / final_frame. No extra text.
{style_text}
{negative_text}"""
